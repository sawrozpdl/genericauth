...
const Policy = (props: any) => {
  ...
  return (
    <>
      ...
      <p>
        Saroj Paudyal built the Kcha app as a Free app. This SERVICE is provided
        by Saroj Paudyal at no cost and is intended for use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Kcha unless otherwise
      ...
      <p>
        ...
        but not limited to Contacts, Gallery Access, Internet. The information
      ...
      <p>
        ...
        hesitate to contact me at sarojpaudyal53@gmail.com.
      </p>{' '}
      <p>
